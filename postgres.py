...
DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql://username:password@localhost:5432/employees_db')
...
def execute_query():
    ...
    try:
        ...
        prompt = f"Convert the following natural language query to SQL for PostgreSQL. Also the sql code should not have ``` in beginning or end and sql word or SQL word in output. Respond only with the SQL query and no other text: '{natural_language_query}'."
